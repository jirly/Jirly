...
public class MsgCodeController {
    ...
    public Response send(@Valid VoiceCodeDTO voiceCodeDTO) {
        ...
        // load user sign
        final UserSign userSign = getUserSign(phrase.getSignId(), Integer.valueOf(voiceCodeDTO.getSid()));
    ...
    private UserSign getUserSign(Integer signId, Integer enterpriseId) {
        return userSignService.get(signId, enterpriseId);
    }
}
